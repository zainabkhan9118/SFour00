              ...
              <div className="flex flex-col items-end">
                <div className="flex gap-2 mb-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 bg-orange-500 text-white px-6 py-3 rounded-full font-medium"
                  >
                    Apply Now
                ...
                <div className="text-xs text-gray-600">
                  Job expires in{" "}
                  <span className="text-orange-500 font-medium">June 30, 2021</span>
                </div>
              </div>
            </div>

            {/* Info cards */}
            <div className="flex flex-wrap justify-end gap-8 my-8">
              {/* Salary card */}
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              ...
              <div className="bg-white rounded-lg shadow-lg w-full max-w-md mx-4">
                <button
                  ...
                  className="text-gray-900 absolute rounded-full hover:text-gray-500"
                >
                  <div className="text-orange-500 py-2 px-4 rounded-full text-[20px] bg-slate-100 mt-[-15px] ml-[420px]">
                    X
                  </div>
                </button>
                <div className="p-6">
                  ...
                  <form className="space-y-5">
                    {/* Resume Upload */}
                    <div className="border border-dashed border-gray-300 rounded-full p-4 flex flex-col items-center justify-center">
                      <div className="flex items-center gap-2 text-gray-500">
                        <Upload className="w-5 h-5 text-blue-500" />
                        <span onClick={handleUpload} className="cursor-pointer">
                          Upload Resume
                        </span>
                        <input
                          type="file"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        id="name1"
                        placeholder="Name..."
                        className="w-full px-3 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-1 focus:ring-orange-500"
                      />
                    </div>
                    ...
                    <div className="flex justify-between pt-4">
                      ...
                      <button
                        onClick={() => navigate("/User-CompanyDetails")}
                        type="submit"
                        className="w-[248px] h-[56px] bg-orange-500 text-white rounded-full text-sm font-medium flex items-center gap-2"
                      >
                        Apply Now
                        <ArrowRight className="w-4 h-4" />
                      </button>
