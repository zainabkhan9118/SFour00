...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar component */}
      <div 
        className={`fixed md:static md:translate-x-0 h-screen z-20 bg-[#121D34] text-gray-400 flex flex-col p-5 border rounded-lg transition-transform duration-300 ease-in-out ${
