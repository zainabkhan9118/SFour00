  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Message */}
        <p className="text-gray-500 dark:text-gray-400 text-center mt-2 w-full max-w-xs md:w-[400px] lg:w-[421px] text-lg">
        ...
        <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4 mt-6 w-full">
          <button
            ...
            className="px-6 py-2 w-full md:w-[140px] h-12 bg-[#1F2B44] dark:bg-gray-900 text-white rounded-full hover:bg-gray-700 dark:hover:bg-gray-800 transition duration-200"
          >
            Okay
          </button>
        </div>
