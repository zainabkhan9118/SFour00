...
const ProfileSuccessPopup = ({ message, redirectPath, onClose }) => {
    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full shadow-xl animate-fadeIn">
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-lg font-semibold mb-2 text-gray-800 dark:text-gray-100">Success!</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-6">{message || "Your profile has been saved successfully."}</p>
